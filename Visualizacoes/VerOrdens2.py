...
class Tela32:
    ...
    def __init__(self, cpf):
        ...
        self.janela_principal.title("Sistema de serviços do Mecânico")
        ...
        self.titulo = Label(self.frame1, text="Sistema de Gerenciamento do Mecânico", font=("Century Gothic", 18, "bold"), bg="#535c68", fg="white")
        ...
        self.btnConcluidas.grid(row=0, column=0, padx=10)
        ...
        self.btnAtivas.grid(row=0, column=1, padx=10)
