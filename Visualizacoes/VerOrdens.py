...
class Tela12:
    ...
    def __init__(self):
        ...
        self.db = DatabaseOrdem("bd.db")

        self.janela_principal = Tk()
        self.janela_principal.title("Ordens de Serviço")
        ...
        self.titulo = Label(self.frame1, text="Ordens de Serviço", font=("Century Gothic", 18, "bold"), bg="#535c68", fg="white")
        ...
        self.btnDel = Button(self.frame2, text="Deletar", width=15, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#16a085", command = self.del_ordem)
        self.btnDel.grid(row=0, column=0, padx=10)

        self.btnFinalizar = Button(self.frame2, text="Concluir", width=15, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#16a085", command = self.concluir_ordem)
        self.btnFinalizar.grid(row=0, column=1, padx=10)

        self.btnConcluidas = Button(self.frame2, text="Ver Concluidas", width=15, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#16a085", command = self.ver_concluidas)
        self.btnConcluidas.grid(row=0, column=2, padx=10)

        self.btnAtivas = Button(self.frame2, text="Ver Ativas", width=15, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#16a085", command = self.displayAll)
        self.btnAtivas.grid(row=0, column=3, padx=10)
        ...
        self.style.configure("mystyle.Treeview", font=("Century Ghothic, 18"))
       ...
       # self.tv.column("4", width=165, stretch=NO)
        self.tv.heading("4", text="Valor R$")
    ...
    def del_ordem(self):
        ...
        messagebox.showinfo("Sucesso", "Ordem de Serviço Deletada")
        self.displayAll()

    def concluir_ordem(self):
        self.db.update(row[0], row[1], row[2], row[3], row[4])
        messagebox.showinfo("Sucesso", "Ordem de Serviço Finalizada")
        self.displayAll()
