...
class Tela3:
    ...
    def __init__(self, id, cpf):
        ...
        self.btnOrçamento = Button(self.frame2, command=self.add_orçamento, text="Cadastrar Orçamento", width=20, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#CA0000")
        self.btnOrçamento.pack(padx=10, pady=10)

        self.btnOrdem = Button(self.frame2, command=self.ver_ordem, text="Visualizar Ordem de serviço", width=25, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#5F00B2")
        self.btnOrdem.pack(padx=10, pady=10)

        self.btnTrocarSenha = Button(self.frame2, command=self.trocar_senha, text="Redefinir Senha", width=20, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#0040B7")
