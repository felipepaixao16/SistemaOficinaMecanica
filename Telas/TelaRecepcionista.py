...
class Tela2:
    ...
    def __init__(self, id):
        ...
        self.btnCadastrar = Button(self.frame2, command=self.add_cliente, text="Cadastrar Cliente", width=15, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#CA0000")
        ...
        self.btnOrcamento = Button(self.frame2, command=self.ver_orcamento, text="Ver Orçamentos", width=15, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#5F00B2")
        self.btnOrcamento.pack( padx=10, pady=10)

        self.btnTrocarSenha = Button(self.frame2, command=self.trocar_senha, text="Redefinir Senha", width=15, font=("CENTURY GOTHIC", 16, "bold"), fg="white", bg="#0040B7")
